...
def hook_AZURE_ENVIRONMENT_TO_IMAGE(
    *, logger: gluetool.log.ContextAdapter, pool: AzureDriver, environment: Environment,
) -> Result[PoolImageInfo, Failure]:
    return map_environment_to_image_info(logger, pool, environment, mapping_filename='artemis-image-map-azure.yaml')
