...
func TestGroupModule(t *testing.T) {
	...
	//Generate uuid to use as group name
	uuid := uuid.New()
	...
	terraformOptions := &terraform.Options{
		...
		Vars: map[string]interface{}{
			"group_name": "gitlab-module-test-group-" + uuid.String(),
			"group_path": "gitlab-module-test-group-" + uuid.String(),
			"description": "gitlab-module-test-group-" + uuid.String(),
	...
	output := terraform.Output(t, terraformOptions, "group_id")
