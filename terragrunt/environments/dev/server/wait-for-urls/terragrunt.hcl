...
inputs = {
  ...
  urls = [
    "api.dev-${get_env("USER", "unknown")}.testing-farm.io/v0.1/about",
    "internal.api.dev-${get_env("USER", "unknown")}.testing-farm.io/v0.1/about",
    "tmt.dev-${get_env("USER", "unknown")}.testing-farm.io"
  ]
}
